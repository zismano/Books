		...
		addAuthor: {
			...
			resolve(parent, args) {
				let author = new Author({
					name: args.name,
					age: args.age
				});	// author is a new instance of Author from mongoose
				return author.save();	// save author to mongodb and then return it
			}
		},
		addBook: {
			type: BookType,
...
/*
	// add author Ofir, 30 and after creating it, what data would you like to get back (name, age)
  mutation {
	addAuthor(name: 'Ofir', age: 30) {
		name
		age
	}
  }
